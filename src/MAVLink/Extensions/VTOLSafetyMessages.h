...
/// to a companion-computer ROS2 pipeline.
...
#define MAVLINK_MESSAGE_INFO_WEATHER_FORECAST { \
    ...
    {  { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_weather_forecast_t, latitude) }, \
       ...
       { "weather_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_weather_forecast_t, weather_type) }, \
       { "severity", NULL, MAVLINK_TYPE_UINT8_T, 0, 21, offsetof(mavlink_weather_forecast_t, severity) }, \
       { "confidence", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_weather_forecast_t, confidence) }, \
       { "wind_speed", NULL, MAVLINK_TYPE_UINT16_T, 0, 23, offsetof(mavlink_weather_forecast_t, wind_speed) }, \
       { "wind_direction", NULL, MAVLINK_TYPE_UINT16_T, 0, 25, offsetof(mavlink_weather_forecast_t, wind_direction) }, \
       { "temperature", NULL, MAVLINK_TYPE_INT16_T, 0, 27, offsetof(mavlink_weather_forecast_t, temperature) }, \
       { "rainfall", NULL, MAVLINK_TYPE_UINT16_T, 0, 29, offsetof(mavlink_weather_forecast_t, rainfall) }, \
       { "visibility", NULL, MAVLINK_TYPE_UINT16_T, 0, 31, offsetof(mavlink_weather_forecast_t, visibility) }, \
    ...
    const char *description)
{
    ...
    _mav_put_uint8_t(buf, 20, weather_type);
    _mav_put_uint8_t(buf, 21, severity);
    _mav_put_uint8_t(buf, 22, confidence);
    _mav_put_uint16_t(buf, 23, wind_speed);
    _mav_put_uint16_t(buf, 25, wind_direction);
    _mav_put_int16_t(buf, 27, temperature);
    _mav_put_uint16_t(buf, 29, rainfall);
    _mav_put_uint16_t(buf, 31, visibility);
...
#define MAVLINK_MESSAGE_INFO_ALTERNATE_LANDING { \
    ...
    {  { "site_id", NULL, MAVLINK_TYPE_CHAR, 16, 0, offsetof(mavlink_alternate_landing_t, site_id) }, \
       { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 16, offsetof(mavlink_alternate_landing_t, latitude) }, \
       { "longitude", NULL, MAVLINK_TYPE_INT32_T, 0, 20, offsetof(mavlink_alternate_landing_t, longitude) }, \
       { "altitude", NULL, MAVLINK_TYPE_INT32_T, 0, 24, offsetof(mavlink_alternate_landing_t, altitude) }, \
       { "site_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 28, offsetof(mavlink_alternate_landing_t, site_type) }, \
       { "priority", NULL, MAVLINK_TYPE_UINT8_T, 0, 29, offsetof(mavlink_alternate_landing_t, priority) }, \
       { "runway_length", NULL, MAVLINK_TYPE_UINT16_T, 0, 30, offsetof(mavlink_alternate_landing_t, runway_length) }, \
       { "runway_heading", NULL, MAVLINK_TYPE_UINT16_T, 0, 32, offsetof(mavlink_alternate_landing_t, runway_heading) }, \
       { "surface_condition", NULL, MAVLINK_TYPE_UINT8_T, 0, 34, offsetof(mavlink_alternate_landing_t, surface_condition) }, \
       { "distance_from_current", NULL, MAVLINK_TYPE_UINT32_T, 0, 35, offsetof(mavlink_alternate_landing_t, distance_from_current) }, \
    ...
    const char *description)
{
    ...
    _mav_put_char_array(buf, 0, site_id, 16);
    _mav_put_int32_t(buf, 16, latitude);
    _mav_put_int32_t(buf, 20, longitude);
    _mav_put_int32_t(buf, 24, altitude);
    _mav_put_uint8_t(buf, 28, site_type);
    _mav_put_uint8_t(buf, 29, priority);
    _mav_put_uint16_t(buf, 30, runway_length);
    _mav_put_uint16_t(buf, 32, runway_heading);
    _mav_put_uint8_t(buf, 34, surface_condition);
    _mav_put_uint32_t(buf, 35, distance_from_current);
...
static inline uint16_t mavlink_msg_alternate_landing_get_site_id(const mavlink_message_t* msg, char *site_id)
    { return _MAV_RETURN_char_array(msg, site_id, 16, 0); }
...
#define MAVLINK_MESSAGE_INFO_VIDEO_CTRL { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_video_ctrl_t, target_system) }, \
       { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_video_ctrl_t, target_component) }, \
       { "camera_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_video_ctrl_t, camera_id) }, \
       { "command", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_video_ctrl_t, command) }, \
       { "resolution_w", NULL, MAVLINK_TYPE_UINT16_T, 0, 4, offsetof(mavlink_video_ctrl_t, resolution_w) }, \
       { "resolution_h", NULL, MAVLINK_TYPE_UINT16_T, 0, 6, offsetof(mavlink_video_ctrl_t, resolution_h) }, \
       { "framerate", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_video_ctrl_t, framerate) }, \
       { "bitrate_kbps", NULL, MAVLINK_TYPE_UINT16_T, 0, 9, offsetof(mavlink_video_ctrl_t, bitrate_kbps) }, \
    ...
    uint8_t framerate, uint16_t bitrate_kbps, const char *codec)
{
    ...
    _mav_put_uint8_t(buf, 3, command);
    _mav_put_uint16_t(buf, 4, resolution_w);
    _mav_put_uint16_t(buf, 6, resolution_h);
    _mav_put_uint8_t(buf, 8, framerate);
    _mav_put_uint16_t(buf, 9, bitrate_kbps);
