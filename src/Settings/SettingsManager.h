...
class SettingsManager : public QObject
{
    ...
    Q_MOC_INCLUDE("CryptoSettings.h")
    ...
    Q_PROPERTY(QObject *cryptoSettings                  READ cryptoSettings                 CONSTANT)
...
public:
    ...
    CryptoSettings *cryptoSettings() const;
...
private:
    ...
    CryptoSettings *_cryptoSettings = nullptr;
